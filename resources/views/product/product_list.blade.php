            ...
            <div class="product product-11 mt-v3 text-center">
                ...
                <div class="product-body">
                    <div class="product-cat">
                        <a href="javascript:;">{{ $featured->subcategory->subcategory_name }}</a>
                    </div>
                    <h3 class="product-title"><a href="{{ route('single.product',$featured->slug) }}">{{ $featured->title }}</a></h3><!-- End .product-title -->
