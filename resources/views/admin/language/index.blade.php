 ...
 <!-- Content Wrapper. Contains page content -->
      ...
      <div class="container-fluid">
        ...
        <div class="card">
          <div class="card-header">
             <button type="submit" class="btn btn-success btn-sm float-right"  data-bs-toggle="modal" data-bs-target="#staticBackdrop"><i class="fa fa-plus"></i> Add New Language</button>
    ...
    <div class="modal-dialog modal-md">
      <div class="modal-content">
        <div class="modal-header bg-success">
          <h1 class="modal-title fs-5" id="staticBackdropLabel">Language Information</h1>
          <button type="button" class="btn-close btn-close-white" data-bs-dismiss="modal" aria-label="Close"></button>
        </div>
        <div class="modal-body">
          <form action="{{ route('language.store') }}" method="post" id="add_form" enctype="multipart/form-data">
            @csrf
              <div class="mb-3">
              ...
              <div class="mb-3">
               ...
               <div class="mb-3">
                ...
                <input type="text" class="form-control" id="app_lang_code" aria-describedby="emailHelp" name="app_lang_code" placeholder="Put ISO 639-1 code for your language">
              </div>
  ...
  <div class="modal fade" id="editModal" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
    <div class="modal-dialog modal-md">
      <div class="modal-content">
        <div class="modal-header bg-success">
          <h1 class="modal-title fs-5" id="staticBackdropLabel">Update Language Info</h1>
          <button type="button" class="btn-close btn-close-white" data-bs-dismiss="modal" aria-label="Close"></button>
        </div>
  ...
  <script type="text/javascript">
    ...
    $(function Language(){
       table=$('.dataTable').dataTable({
        ...
        columns:[
          ...
          {data:'name' , name:'name'},
          {data:'code' , name:'code'},
          {data:'app_lang_code' , name:'app_lang_code'},
    ...
    $('body').on('click','.edit',function(){
      var id=$(this).data('id');
      var url="{{ url('admin/language/edit') }}/"+id;
      $.ajax({
        url:url,
        type:'get',
        success:function(data){
    ...
    //Hide status ----
     $('body').on('click','#lang_active',function(){
        var id=$(this).data('id');
        var url="{{ url('admin/language/deactive') }}/"+id;
        $.ajax({
          url:url,
          type:'get',
          success:function(data){
     ...
     //Show Counter status---
     $('body').on('click','#lang_deactive',function(){
          var id=$(this).data('id');
          var url="{{ url('admin/language/active') }}/"+id;
          $.ajax({
            url:url,
            type:'get',
            success:function(data){
